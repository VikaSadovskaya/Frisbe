...
global.startGame = function (activeSession) 
{
    ...
    if(global.snappablesSystem.getActiveSession().getGlobalStore().getBool("finish"))
    {
        global.snappablesSystem.getActiveSession().getCurrentPlayerStore(global.REPOSITORY.currentPlayerIndex).clear()
        global.snappablesSystem.getActiveSession().getGlobalStore().clear()
